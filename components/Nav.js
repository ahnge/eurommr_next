...
const Nav = () => {
  ...
  return (
    <div
      ...
      } lg:left-0 lg:rounded-none lg:bg-white shadow-xl z-20`}
    >
        ...
        <div className="flex flex-col items-center space-y-2">
          <Link to="/" className="cursor-pointer">
            <a className="flex space-x-1 items-center text-text_wm dark:text-text_dm  hover:text-yellow-600  font-normal transition dark:hover:text-yellow-400">
              <Facebook />
              <p className=" text-lg tracking-normal">Find us on facebook.</p>
            </a>
          </Link>
          <p className=" text-xs font-light xlr:text-sm text-text_wm dark:text-text_dm ">
            2022&copy; All Rights Served.
          </p>
        </div>
      </div>
